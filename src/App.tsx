...
export default function App() {
  ...
  const links: LinkItem[] = [
    ...
    {
      id: "instagram",
      title: "Komnot Instagram",
      description: "@komnotcambodia • News, alerts & community updates",
      url: "https://www.instagram.com/komnotcambodia/?hl=en",
      icon: <Instagram className="w-5 h-5 text-white" />,
      brandColor:
        "bg-gradient-to-r from-violet-600 via-pink-500 to-orange-400 hover:from-violet-700 hover:via-pink-600 hover:to-orange-500",
    },
    {
      id: "x",
      title: "Komnot on X",
      description: "@KomnotCambodia • Follow our latest updates",
      url: "https://x.com/KomnotCambodia",
      icon: <XIcon className="w-5 h-5 text-white" />,
      brandColor:
        "bg-gradient-to-r from-slate-800 to-black hover:from-slate-900 hover:to-black",
    },
    {
      id: "tiktok",
      title: "Komnot TikTok",
